        ...
        <div className="max-w-3xl mx-auto">
          <div className="space-y-8 text-black">
            <Card className="border-l-4 border-l-[#F97316] shadow-lg ">
              <CardContent className="p-6">
                <p className="text-lg">
                  You’re more focused on stacking certificates than actually
                  using the skills. Simply put, we don't have the same goals.
                </p>
              </CardContent>
            </Card>
            <Card className="border-l-4 border-l-[#F97316] shadow-lg">
              <CardContent className="p-6">
                <p className="text-lg">
                  You think anyone with writing knowledge can write copy. This
                  is a common misconception of those who don't truly know the
            ...
            <Card className="border-l-4 border-l-[#F97316] shadow-lg">
              <CardContent className="p-6">
                <p className="text-lg">
                  You're looking for easy money, we're not peddling dreams of
            ...
            <Card className="border-l-4 border-l-[#F97316] shadow-lg">
              <CardContent className="p-6">
                <p className="text-lg">
                  ...
                  original copywriters whose copy beats AI everytime
                </p>
              </CardContent>
            </Card>
          </div>
