    ...
    <section className="py-16 px-4  text-black">
      <div className="container mx-auto">
        ...
        <div className="text-center">
          <Button onClick={handleCtaClick} size="lg" className="bg-[#F97316] hover:bg-[#E86305] text-white px-6 py-6  laptop:px-8 laptop:py-6  text-sm laptop:text-lg rounded-xl">
